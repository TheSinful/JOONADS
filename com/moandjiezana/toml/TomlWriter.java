...
public class TomlWriter {
   ...
   public void write(Object from, File target) throws IOException {
      ...
      try {
         this.write(from, (OutputStream)outputStream);
      } finally {
         outputStream.close();
      }
   ...
   // $FF: synthetic method
   TomlWriter(int x0, int x1, int x2, TimeZone x3, boolean x4, Object x5) {
      this(x0, x1, x2, x3, x4);
   }
